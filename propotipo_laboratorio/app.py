...
def conectar_rabbitmq():
    ...
    channel.queue_declare(queue="prototipo_laboratorio")  # Cola de respuesta
...
def recibir_respuesta():
    ...
    channel.basic_consume(queue="prototipolaboratorio", on_message_callback=callback, auto_ack=True)
